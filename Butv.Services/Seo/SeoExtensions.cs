...
namespace BUTV.Services.Seo
{
    public static class SeoExtensions
    {
        ...
        public static string GetSeName<T>(this T entity, bool returnDefaultValue = true)
      where T : BaseEntity, ISlugSupported
        ...
        public static string GetSeName(int entityId, string entityName, bool returnDefaultValue = true)
        {
            string result = string.Empty;

            var urlRecordService = EngineContext.Instance.GetService(typeof(IUrlRecordService)) as IUrlRecordService;
        ...
        public static string ValidateSeName(int entityId, string entityName, string seName, string name, bool ensureNotEmpty)
        {
            ...
            //validation
            seName = GetSeName(seName, true, false);
            ...
            while (true)
            {
                ...
                var reserved1 = urlRecord != null && !(urlRecord.EntityId == entityId && urlRecord.EntityName.Equals(entityName, StringComparison.OrdinalIgnoreCase));
